...
You should include a sentence which interprets the figure. Your formatted R Markdown output file (.html or .pdf) should be submitted by email to `nhorton@amherst.edu` before the start of class on Wednesday, October 15th and cc'ed to all group members.  Please use the subject line `STAT135: scraping` for the message.
