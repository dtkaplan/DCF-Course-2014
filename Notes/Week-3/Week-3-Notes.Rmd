...
Data transfiguration and graphing exercises:

## Fashions in Naming

Objective: create a graph like the following comparing names that strike you as interesting.
...
Results %>% ggplot(aes(x=year,y=total,group=name)) +
  ...
  ylab("Self-Normalized Popularity") + xlab("Year")
```
