...
Picture of Legos  | Picture of lego model
----------------- | ----------------------
...
* R and RStudio. 
    ...
    * Installing on your own computer.  You need both of these:
        ...
        * [RStudio desktop software](http://www.rstudio.com/products/RStudio/#Desk) CHANGE THIS TO THE preview edition.
...
#. Check for packages: devtools, ggplot2, dplyr, DCF (from Github), mosaicData, NHANES, DCFinteractive, mosaic, knitr, rmarkdown, rpart, shiny, manipulate ... PUT THESE IN A COMMAND DOCUMENT
...
Create an Rmd file named `Class-1.Rmd`.  Eventually, you will upload your HTML file to Moodle, under [In-class, Week 1](Moodle link here.)
...
When done, upload it to Moodle, under [In-class, Week 1](Moodle link here).
