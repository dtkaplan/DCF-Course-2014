...
<h4 title="Wed. 10 Sept." class="this-week">Week 1</h4> 
...
[Notes from Class](Notes/Week-1-Notes.html)
...
* Notes: 
    ...
    [Data Verbs](`r Notes("BasicDataCommands")`) & [Join](`r Notes("BasicDataCommands", "Join.html")`),
