...
* **HELP!** Available each evening with the HHMI Stats Fellows, location Olin-Rice 245. Sunday through Thursday 7:00-9:30pm.
...
[Assignment 1](`r Assignment("Assignment-One")`) due Fri. Sept. 20. [Hand in here.](https://moodle.macalester.edu/mod/assign/view.php?id=19069)
  ...
  <div class="clearfix visible-sm-block"></div>
   <div class="col-sm-6 col-md-4 col-lg-3">
   <h4 title="Wed. 17 Sept." >Week 2</h4>
...
<hr class="syllabus">
   ...
   <div class="col-sm-6 col-md-4 col-lg-3">
   <h4 title="Oct. 1"  class="this-week">Week 3</h4>
...
* Notes: 
    ...
    [Graphics: Facets and Layers](`r Notes("GraphingIntro/BasicCommands.html")`)  
...
* Notes:  [Wide versus Narrow](`r Notes("WideAndNarrow")`), [Ranks](`r Notes("Rank")`), [Graphing Networks](TBA), [Within group operations](TBA)
...
* Notes: [Graphics Choices](`r Notes("GraphicsChoices","DraftNarrative.html")`), [Densities and distributions](`r Notes("Statistics","DraftNarrative.html")`)
